...
class CTPersonalAccountViewController: UIViewController {
...
// MARK: - private Method
extension CTPersonalAccountViewController {
...
extension CTPersonalAccountViewController: UITableViewDelegate {
...
extension CTPersonalAccountViewController: UITableViewDataSource {
    func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return 1
    }
    
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("CTPersonalLogoutCell", forIndexPath: indexPath) as! CTPersonalLogoutCell
        cell.titleLbl.text = "修改密码"
        return cell
    }
}

class CTPersonalLogoutCell: UITableViewCell {
